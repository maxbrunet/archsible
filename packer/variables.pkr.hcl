...
variable "iso_checksum" {
  ...
  default     = "file:https://mirrors.kernel.org/archlinux/iso/2021.01.01/sha1sums.txt"
}

variable "iso_url" {
  type        = string
  description = "A URL to the ISO containing the installation image."
  default     = "https://mirrors.kernel.org/archlinux/iso/2021.01.01/archlinux-2021.01.01-x86_64.iso"
}
